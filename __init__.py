...
APP_CONTENT = {
    "Home":[["Welcome","/welcome/","Welcome to my App, you can do many things here."],["Background","/background/","We had a lot of fun building this app. Learn more about our story"],["Messages","/messages/","Get your messages from the community!"]], 
